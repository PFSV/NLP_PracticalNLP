# -*- coding: utf-8 -*-
"""practicalNLP_SVM_model8.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1sxD9Mtt1DxseWOkdXCF-T6uLZqyrtJbr
"""
...
vectorizer = CountVectorizer(strip_accents="unicode", token_pattern = r"(?u)\b\w\w+\b|'\w+",ngram_range = (1,2))      # 데이터를 벡터화 해주는 모델 
