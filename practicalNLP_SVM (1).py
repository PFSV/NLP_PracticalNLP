...
Original file is located at
    https://colab.research.google.com/drive/1hpdHQVSih4PSDRyimS5ah6TCFDp-Sw4Q
"""
...
ko_stop_words = ['은','는','이','가','께서','에서','부터','까지','에게','한테','와','과','을','를','의','로서','로','그리고','즉','게다가']


vectorizer = CountVectorizer(stop_words=ko_stop_words)      # 데이터를 벡터화 해주는 모델  '\w+'" -> 성능 오름 '\w+", 강의자료가 기준모델
